...
if __name__ == '__main__':
    ...
    C1 = Conversation(sender_id=12345, name='irfanc', flow="configure", phone=1234678345678, convo=L)
    C1.addToDB()
    print(C1.storeJSON())
    C2 = Conversation(sender_id=435345, name='irfanc', flow="configure", phone=1234678345678, convo=L)
    print(C2.storeJSON())
    C2.addToDB()
    C3 = Conversation(sender_id=3776, name='irfanc', flow="configure", phone=1234678345678, convo=L)
    print(C3.storeJSON())
    C3.addToDB()
